...
const devs = ['516944013874429964'];
const db = require('quick.db');
const premium = ['516944013874429964']
...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = [`${client.guilds.size} Server`,'Type -help',`${client.users.size} Members`,'-inv'];
    var i = -1;
    var j = 0;
...
client.on('message', message => {
  ...
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/PvXFbGD**")
...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/oauth2/authorize?client_id=544200790105915414&scope=bot&permissions=8')
  .setDescription(`**
...
if (message.content.startsWith('$users')){
 if(!message.author.id === '544200790105915414') return;
...
client.on('message', message => {
  ...
  if (message.author.id !== '545635609738215424') return;


if (message.content.startsWith(prefix + 'playing')) {
if (message.author.id !== '545635609738215424') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
client.user.setGame(argresult);
...
client.on('message', message => {
if(message.content.includes("<@516944013874429964>")) {
